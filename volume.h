...
class isotropic : public material
{
    public:
        ...
        virtual bool scatter(const ray& r, const hit_recoord& rec, vec3& attenuation, ray& scattered) const
        {
...
bool constant_medium::hit(const ray& r, float t_min, float t_max, hit_recoord& rec) const
{
    bool db = (drand48() < 0.00001);
    db = false;
    hit_recoord rec1, rec2;
